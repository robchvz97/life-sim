...
function maybeTransferResources(a,p,dt){
  ...
  const willingness=generosity*.32+reciprocity*debt*.34+
    kinshipScore(a,b)*(a.genome.cognition?.kinBias||.45)*.25+Math.max(0,reputationScore(a,b))*.22;
  ...
  const needGift=a.energy>64&&b.energy<57;
...
function snapshotAgent(a){
  return {
    ...
    carryingData:a.carrying?{type:a.carrying.type,props:a.carrying.props,waterAmount:a.carrying.waterAmount,waterTemp:a.carrying.waterTemp,softness:a.carrying.softness,shaping:a.carrying.shaping,rotationTurns:a.carrying.rotationTurns,mechanicalWork:a.carrying.mechanicalWork,temperature:a.carrying.temperature,wetness:a.carrying.wetness,thermalState:a.carrying.thermalState,transformedLevel:a.carrying.transformedLevel,originRegion:a.carrying.originRegion,lastRegion:a.carrying.lastRegion,regionalMoves:a.carrying.regionalMoves,groundScrapeWork:a.carrying.groundScrapeWork||0}:null
  };
}
